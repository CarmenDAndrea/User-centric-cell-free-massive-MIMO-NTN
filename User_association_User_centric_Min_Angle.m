function [Alpha_association, Satellites_Load] = User_association_User_centric_Min_Angle(sr,N_UC,Num_Total_satellites,index_satellites,theta_angles_UT,phi_angles_UT,min_Angle_SAT)
